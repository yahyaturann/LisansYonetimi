export class LisansDogrulamaServisi {
    ...
    async dogrula(girdi) {
        ...
        if (proje.settings.domain_kontrol) {
            ...
            if (lisans.metadata.domain !== girdi.domain) {
                await this.depo.logOlustur(girdi.projectId, `Lisans doğrulama başarısız: Domain uyuşmuyor. ${lisans.metadata.domain} !== ${girdi.domain}`);
                return {
                    success: false,
        ...
        if (proje.settings.ip_kontrol) {
            ...
            if (!lisans.metadata.ip) {
                ...
                await this.depo.logOlustur(girdi.projectId, `Lisans doğrulama başarısız: IP uyuşmuyor. ${lisans.metadata.ip} !== ${girdi.ip}`);
                return {
                    success: false,
        ...
        if (proje.settings.hwid_kontrol) {
            ...
            if (!lisans.metadata.hwid) {
                ...
                // Sonraki aktivasyonlarda doğrula
                await this.depo.logOlustur(girdi.projectId, `Lisans doğrulama başarısız: HWID uyuşmuyor. ${lisans.metadata.hwid} !== ${girdi.hwid}`);
                return {
                    success: false,
...
//# sourceMappingURL=lisans-dogrulama-servisi.js.map