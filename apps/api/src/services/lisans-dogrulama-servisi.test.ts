...
import {
  LisansDogrulamaServisi,
  type LisansDogrulamaDeposu
} from "./lisans-dogrulama-servisi";

function depoOlustur(ozelAlanlar: Partial<LisansDogrulamaDeposu> = {}): LisansDogrulamaDeposu {
  return {
    sonErisimZamaniniGuncelle: vi.fn().mockResolvedValue(undefined),
